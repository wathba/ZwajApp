...
namespace ZwajApp.Api.Migrations
{
    ...
    [Migration("20201128030956_azureMigratiom")]
    partial class azureMigratiom
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZwajApp.Api.Model.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ZwajApp.Api.Model.Role")
                        .WithMany()
            ...
            modelBuilder.Entity("ZwajApp.Api.Models.UserRole", b =>
                {
                    b.HasOne("ZwajApp.Api.Model.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade);
